  ...
  return (
    <section className='bg-black px-6 lg:px-36 lg:pt-36 pt-14  md:pt-32 lg:h-screen h-auto'>
      ...
      <motion.h1
          ...
          initial="hidden"
          animate="visible"
          className='text-pink-600 lg:text-7xl font-Style text-center font-bold pb-16 md:text-6xl text-5xl'>My Works</motion.h1>   
      <motion.div 
          className=' flex gap-24 font-Alegreya font-bold flex-1 flex-wrap  px-12 items-center justify-center'>
        <motion.div variants={childVariant}
        initial="hidden"
        animate="visible"
        transition={{duration:0.6}} className='h-96 group card w-96 bg-white  text-black relative '>
          <img src={cover } className='object-cover h-96 lg:group-hover:h-72 duration-300 w-full  ' />
        ...
        initial="hidden"
        animate="visible"
        transition={{delay:0.2,duration:0.6}} className='h-96 group card w-96 bg-white  text-black relative '>
          <img src={pfolio} className='object-cover h-96 group-hover:h-72 duration-300 w-full  ' />
        ...
        initial="hidden"
        animate="visible"
        transition={{delay:0.4, duration:0.6}} className='h-96 group card w-96 bg-white  text-black relative '>
